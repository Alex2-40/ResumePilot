...
export function Aurora({
  colorStops = ["#9be7ff", "#c7b7ff", "#98f3c1"],
  speed = 0.72,
  blend = 0.34,
  amplitude = 0.68,
  className = "",
  ...
  useEffect(() => {
    ...
    const makeColorStops = (stops: [string, string, string]) =>
      stops.map((hex) => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColorStops: { value: makeColorStops(colorStops) },
    ...
    const tick = (time: number) => {
      ...
      program.uniforms.uColorStops.value = makeColorStops(current.colorStops);
